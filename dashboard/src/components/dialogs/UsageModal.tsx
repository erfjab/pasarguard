...
function CustomBarTooltip({ active, payload }: TooltipProps<any, any>) {
  ...
  return (
    <div
      className={`min-w-[160px] rounded border border-border bg-gradient-to-br from-background to-muted/80 p-2 text-xs shadow ${i18n.language === 'fa' ? 'text-right' : 'text-left'}`}
      dir={i18n.language === 'fa' ? 'rtl' : 'ltr'}
    >
      <div className={`mb-1 text-xs font-semibold ${i18n.language === 'fa' ? 'text-right' : 'text-center'}`}>
